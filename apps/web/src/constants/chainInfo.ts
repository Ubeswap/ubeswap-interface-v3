...
const CHAIN_INFO: ChainInfoMap = {
  [ChainId.MAINNET]: {
    ...
    infoLink: 'https://info.ubeswap.org/#/',
    label: 'Ethereum',
  ...
  [ChainId.OPTIMISM]: {
    ...
    infoLink: 'https://info.ubeswap.org/#/optimism/',
    label: 'Optimism',
  ...
  [ChainId.ARBITRUM_ONE]: {
    ...
    infoLink: 'https://info.ubeswap.org/#/arbitrum',
    label: 'Arbitrum',
  ...
  [ChainId.POLYGON]: {
    ...
    infoLink: 'https://info.ubeswap.org/#/polygon/',
    label: 'Polygon',
  ...
  [ChainId.BNB]: {
    ...
    infoLink: 'https://info.ubeswap.org/#/bnb/',
    label: 'BNB Chain',
  ...
  [ChainId.AVALANCHE]: {
    ...
    infoLink: 'https://info.ubeswap.org/#/avax/', // TODO(WEB-2336): Add avax support to info site
    label: 'Avalanche',
  ...
  [ChainId.BASE]: {
    ...
    infoLink: 'https://info.ubeswap.org/#/base/',
    label: 'Base',
  ...
  [ChainId.BLAST]: {
    ...
    infoLink: 'https://info.ubeswap.org/#/blast/',
    label: 'Blast',
    nativeCurrency: { name: 'Ether', symbol: 'ETH', decimals: 18 },
